  ...
  function load() {
    ...
    for (let index in rows) {
      ...
      if (carousel){
        ...
        description += `</div><div class="carousel-inner"><div class="carousel-item active" data-bs-interval="3000"><iframe src="${carouselImgs[0]}" class="d-block" alt="..." width="534" height="333.75"></iframe></div>`;
        for (let i = 1; i < carouselImgs.length; i++){
          description += `<div class="carousel-item" data-bs-interval="3000"><iframe src="${carouselImgs[i]}" class="d-block" alt="..." width="534" height="333.75"></iframe></div>`;
        }

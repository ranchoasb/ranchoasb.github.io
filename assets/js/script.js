  ...
  function show() {
    ...
    if (!next) {
      ...
      tomorrow_displays = {
        ...
        "minimumblock": `Tomorrow is a minimum block day! School starts at 8:25 AM and ends at 12:30 PM, unless you have Extended Day, in which case it ends at 1:50 PM. Classes are 77 minutes long. Today, you will attend only your ${tomorrow.getDate() % 2 ? "odd" : "even"} period classes, as well as Extended Day if you have it.`,

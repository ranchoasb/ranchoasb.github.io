...
//displaying info on index page
  ...
  //carousel (rotating images)
      if (carousel){
        ...
        description += `</div><div class="carousel-inner"><div class="carousel-item active" data-bs-interval="3000"><iframe src="${carouselImgs[0]}" style="position:absolute;left:50%;transform:translateX(-50%)"width="100%" height="100%" class="d-block" alt="..."></iframe></div>`;
        for (let i = 1; i < carouselImgs.length; i++){

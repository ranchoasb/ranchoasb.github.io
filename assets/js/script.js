  ...
  function show() {
    ...
    if (today_date.getYear() > 2023 || (today_date.getYear() == 2023 && today_date.getMonth() > 5 || (today_date.getMonth() == 5 && today_date.getDate() >= 3))) {
      ...
      today_displays = {
        ...
        "minimumblock": `Today is a minimum block day! School starts at 8:25 AM and ends at 12:30 PM, unless you have Extended Day, in which case it ends at 1:50 PM. Classes are 77 minutes long. Today, you will attend only your ${today_date.getDate() % 2 ? "odd" : "even"} period classes, as well as Extended Day if you have it.`,
      ...
      today.textContent = today_displays[daydata[today_date.toLocaleDateString()]];
    }
    ...
    if (!next) {
      ...
      tomorrow_displays = {
        ...
        "minimumblock": `Tomorrow is a minimum block day! School starts at 8:25 AM and ends at 12:30 PM, unless you have Extended Day, in which case it ends at 1:50 PM. Classes are 77 minutes long. Today, you will attend only your ${tomorrow_date.getDate() % 2 ? "odd" : "even"} period classes, as well as Extended Day if you have it.`,
      ...
      tomorrow.textContent = tomorrow_displays[daydata[tomorrow_date.toLocaleDateString()]];
    }
  }

const info = [];
fetch("https://script.google.com/macros/s/AKfycby1YhxB5_-YF5uSiDHP5PTsurBwG9ReYlxsPhYpVlit0WzZteoBwrn-UOaHhkRi60Oj/exec?query=schedule", {mode: "no-cors"}).then(response => {console.log(response.json()); return response.json();}).then(data => {

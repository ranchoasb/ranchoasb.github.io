const info = [];
fetch("https://script.google.com/macros/s/AKfycbzajDjW_ety_msfTgNUqd9KRFEFF22LCL3YEmgzbjOr5bjy1AZ7n95AiWKLh6ZQfpg/exec?query=schedule").then(e => e.json()).then(response => {
      let data = response;

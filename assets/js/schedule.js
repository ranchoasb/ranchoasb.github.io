const info = [];
fetch("https://script.google.com/macros/s/AKfycbyE4ODpJG3Wqwneg7h9tPbsmrwMqzMKEL6mOyY2dS2shfJzhC2g_0CxQrMizGcEVqAg/exec?query=schedule").then(e => e.json()).then(response => {
      let data = response;

const info = [];
fetch("https://script.google.com/macros/s/AKfycbwNi_KfmAaARwpWEP-o-RcaPjn-tMW2HUGXbmok41K6XhYJFoYS0YoybbeSofgkX1Xp/exec?query=schedule").then(e => e.json()).then(response => {
      let data = response;

const info = [];
fetch("https://script.google.com/macros/s/AKfycbwxf0nWaqQeh4XuCFoQrhklFg8dAQhzQOPLj5ck5910shc3dZNZH24x8Vc_zT1Xp4fw/exec?query=schedule").then(e => e.json()).then(response => {
      let data = response;
